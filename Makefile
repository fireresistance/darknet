...
# Korsakov's objects
OBJ+=detector_test.o detector_train.o detector_validate.o socket_demo.o demo_with_class.o detector_test_with_class.o detector_clean_dir_class.o

# End of Korsakov's objects
